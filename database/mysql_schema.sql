...
-- This file contains the complete MySQL schema for production deployment
...
CREATE TABLE parking_slots (
    ...
    slot_type ENUM('COMPACT', 'STANDARD', 'LARGE', 'HANDICAP', 'ELECTRIC') NOT NULL,
...
CREATE TABLE payments (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    amount DECIMAL(10,2) NOT NULL,
    payment_method ENUM('CASH', 'CREDIT_CARD', 'DEBIT_CARD', 'ONLINE', 'MOBILE') NOT NULL,
